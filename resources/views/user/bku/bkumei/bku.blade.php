                    ...
                    <div class="col">
                        <ul class="nav nav-pills justify-content-end">
                            <li class="nav-item mr-2 mr-md-0">
                                <a href="{{route('user.bku.bkumei.bkumeii.sdl', Auth::user()->id)}}"
            ...
            <div class="card-body bg-transparent">
                <div class="row align-items-center">
                    ...
                    <div class="col">
                        <ul class="nav nav-pills justify-content-end">
                            <li class="nav-item mr-2 mr-md-0">
                                <a href="{{route('user.bku.bkumei.bkumeii.bj', Auth::user()->id)}}"
                                    class="nav-link py-2 px-3 active">
                                    <span class="d-md-block">Details</span>
                                </a>
                            </li>
            ...
            <div class="card-body bg-transparent">
                <div class="row align-items-center">
                    ...
                    <div class="col">
                        <ul class="nav nav-pills justify-content-end">
                            <li class="nav-item mr-2 mr-md-0">
                                <a href="{{route('user.bku.bkumei.bkumeii.st', Auth::user()->id)}}"
                                    class="nav-link py-2 px-3 active">
                                    <span class="d-md-block">Details</span>
                                </a>
                            </li>
            ...
            <div class="card-body bg-transparent">
                <div class="row align-items-center">
                    ...
                    <div class="col">
                        <ul class="nav nav-pills justify-content-end">
                            <li class="nav-item mr-2 mr-md-0">
                                <a href="{{route('user.bku.bkumei.bkumeii.bm', Auth::user()->id)}}"
                                    class="nav-link py-2 px-3 active">
                                    <span class="d-md-block">Details</span>
                                </a>
                            </li>
